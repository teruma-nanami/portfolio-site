<x-layout>
    <section>
        <h1 class="text-3xl font-bold text-purple-900 sm:text-4xl">開発プロセス</h1>
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-3">
            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                ...
                <p class="mt-3 text-base text-gray-600 leading-loose">変更理由をIssue、PR、コード差分に紐付けます。</p>
            </div>
            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <p class="text-lg font-bold text-gray-900">AI協調</p>
                <p class="mt-3 text-base text-gray-600 leading-loose">AIの速度を活用し、人間が設計と判断を担います。</p>
            </div>
            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <p class="text-lg font-bold text-gray-900">品質管理</p>
                <p class="mt-3 text-base text-gray-600 leading-loose">実装前後にレビュー工程を設け、手戻りを減らします。</p>
            </div>
        </div>
    </section>

    <section class="mt-12">
        <h2 class="rounded-lg bg-purple-900 px-4 py-2 text-2xl text-white sm:text-3xl">Issue駆動型 AI協調開発フロー</h2>
        <p class="mt-6 text-base text-gray-600 leading-loose">
            要件定義からPRマージまでを、5つのフェーズで管理します。
        </p>

        <div class="mt-6 flex flex-col items-stretch gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 shadow-sm sm:flex-1">
                <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-600 text-sm font-bold text-white">01</span>
                <p class="text-base font-semibold text-gray-900">要件定義</p>
            </div>
            <span class="text-center text-gray-300" aria-hidden="true">
                <span class="sm:hidden">↓</span>
                <span class="hidden sm:inline">→</span>
            </span>
            <div class="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 shadow-sm sm:flex-1">
                <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-600 text-sm font-bold text-white">02</span>
            ...
            <div class="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 shadow-sm sm:flex-1">
                <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-600 text-sm font-bold text-white">03</span>
            ...
            <div class="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 shadow-sm sm:flex-1">
                <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-600 text-sm font-bold text-white">04</span>
            ...
            <div class="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 shadow-sm sm:flex-1">
                <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-600 text-sm font-bold text-white">05</span>
    ...
    <section class="mt-12 space-y-6">
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-2">
                <p class="text-base font-bold text-purple-600">PHASE 01</p>
                <span class="rounded-full bg-purple-50 px-2.5 py-0.5 text-sm font-medium text-purple-700">/requirements</span>
            </div>
            <h3 class="mt-4 text-xl font-bold text-gray-900">対話型要件定義とドキュメント化</h3>
            <p class="mt-6 text-base text-gray-700 leading-loose">
                開発の最初に、AIへいきなりコードを書かせることはしません。<br>
                人間の抽象的な要望を整理し、仕様として扱える状態にしてから開発へ進みます。
            </p>

            <div class="mt-6 rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                <p class="text-base font-semibold text-purple-600">【実践していること】</p>
                <ul class="mt-2 list-disc list-inside space-y-1 text-base text-gray-600">
                    <li>
                        カスタムSkill
                        <code class="rounded bg-white px-1.5 py-0.5 text-red-800 ring-1 ring-gray-200">/requirements [要望の概要]</code>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-2">
                <p class="text-base font-bold text-purple-600">PHASE 02</p>
                <span class="rounded-full bg-purple-50 px-2.5 py-0.5 text-sm font-medium text-purple-700">/issue</span>
            </div>
            <h3 class="mt-4 text-xl font-bold text-gray-900">要件の縦分割設計と GitHub Issue 起票</h3>
            <p class="mt-6 text-base text-gray-700 leading-loose">
                要件をそのまま大きなタスクとして扱うのではなく、ユーザー価値単位でIssueに分割します。<br>
                技術レイヤー単位の横分割は避け、単独で意味のある変更単位にします。
            </p>

            <div class="mt-6 rounded-lg border border-purple-100 bg-purple-50/50 p-3">
                <p class="text-base font-semibold text-purple-700">【分割原則】</p>
                <p class="mt-3 text-base text-gray-600 leading-loose">
                    各Issueは、単独でマージされたときに、利用者または開発者が画面上で確認できる完了状態を持っていること。<br>
            ...
            <div class="mt-6 rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                ...
                <p class="mt-3 text-base text-gray-600 leading-loose">
                    カスタムSkill
                    <code class="rounded bg-white px-1.5 py-0.5 text-red-800 ring-1 ring-gray-200">/issue [要件パス]</code>
                    を使い、受け入れ条件・依存関係・ラベルを整理します。<br>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <p class="text-base font-bold text-purple-600">PHASE 03</p>
            <h3 class="mt-4 text-xl font-bold text-gray-900">実装方針シートによる事前設計レビュー</h3>
            <p class="mt-6 text-base text-gray-700 leading-loose">
                実装前に、AIへ実装方針シートを作成させます。<br>
            ...
            <div class="mt-6 space-y-3">
                ...
                <div class="rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                    ...
                    <p class="mt-3 text-base text-gray-600 leading-loose">
                        ブランチは
                        <code class="rounded bg-white px-1.5 py-0.5 text-red-800 ring-1 ring-gray-200">feature/#XX-task-name</code>
                        の形式で作成し、差分を小さく保ちます。
                    </p>
                </div>
                ...
                <div class="rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                    ...
                    <p class="mt-3 text-base text-gray-600 leading-loose">
                        <code class="rounded bg-white px-1.5 py-0.5 text-red-800 ring-1 ring-gray-200">feat:</code>
                        や
                        <code class="rounded bg-white px-1.5 py-0.5 text-red-800 ring-1 ring-gray-200">fix:</code>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <p class="text-base font-bold text-purple-600">PHASE 04</p>
            <h3 class="mt-4 text-xl font-bold text-gray-900">Claude Code × Gemini による二重レビュー</h3>
            <p class="mt-6 text-base text-gray-700 leading-loose">
                実装後すぐにPRを出すのではなく、AIによるレビュー工程を挟みます。<br>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <p class="text-base font-bold text-purple-600">PHASE 05</p>
            <h3 class="mt-4 text-xl font-bold text-gray-900">人間の最終判断とPRマージ</h3>
            <p class="mt-6 text-base text-gray-700 leading-loose">
                AIによる実装とレビューを活用しつつ、最終的な品質保証とマージ判断は人間が行います。<br>
            ...
            <div class="mt-6 space-y-3">
                ...
                <div class="rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                    ...
                    <p class="mt-3 text-base text-gray-600 leading-loose">
                        PR本文には
                        <code class="rounded bg-white px-1.5 py-0.5 text-red-800 ring-1 ring-gray-200">Closes #Issue番号</code>
